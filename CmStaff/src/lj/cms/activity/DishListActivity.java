...
import lj.cms.R;
import lj.cms.activity.OrderDetailActivity.LvItemTvOnClickListener;
...
public class DishListActivity extends Activity implements ActivityCallBackInterface {
		...
		public void doSome() {
			...
			if(analyzeHelper.recode==AppConstant.ReCodeFinal.OK.code){//成功,加载数据				
				...
				if(null==iatclAdapter){
					iatclAdapter=new ITBCListAdapter(DishListActivity.this, dlAy_dishListLv, list,R.layout.lvitem_dish_list_item, 
							new String[]{"lidli_dishCzQxBt","lidli_dishCzBt","lidli_foodNameTv","lidli_countTv","lidli_statusTv","lidli_validTv"},
							new int[]{R.id.lidli_dishCzQxBt,R.id.lidli_dishCzBt,R.id.lidli_foodNameTv,R.id.lidli_countTv,R.id.lidli_statusTv,R.id.lidli_validTv});
	...
	class LvItemTvOnClickListener extends LvItemBtAttribute {
		...
		public void onClick(View arg0) {
			...
			intent.setClass(DishListActivity.this, FoodDetailActivity.class);
