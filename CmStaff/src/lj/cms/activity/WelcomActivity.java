...
import lj.cms.string_analysis.AnalyzeXmlHelper;
import lj.cms.string_analysis.AppVersionInfoAnalyzeHelper;
...
//				newAppVInfo=axh.getAppVInfo();
				...
				int vCode=this.getPackageManager().getPackageInfo("lj.cms", 0).versionCode;
