        ...
        <g:if test="${restaurantInfo}">
            ...
            <div class="mcm_top">
                ...
                <div class="mcmt_right">
                    ...
                    <a class="btn btn-success" href="${createLink(controller: "infoShow", action: "tablesShow", params: [restaurantId: restaurantInfo.id,restaurantName:restaurantInfo.name])}"
