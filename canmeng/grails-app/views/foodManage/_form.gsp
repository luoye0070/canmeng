...
<div class="control-group">
    ...
    <div class="controls">
        <g:field name="price" value="${fieldValue(bean: foodInfoInstance, field: 'price')}" required=""/>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <g:field name="originalPrice" value="${fieldValue(bean: foodInfoInstance, field: 'originalPrice')}"/>
    </div>
</div>
