    ...
    <g:render template="../layouts/shopMenu" />
        ...
        <form class="form-horizontal" method="POST" action="editShopInfo" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <select id="province" name="provinceSelect">
                        ...
                        <select id="city" name="citySelect">
                        ...
                        <select id="area" name="areaSelect">
                            <option value="">请选择</option>
                        </select>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label>${fieldValue(bean: restaurantInfoInstance, field: 'imageSpaceSize')}</label>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                   <label>${fieldValue(bean: restaurantInfoInstance, field: 'imageSpaceUsedSize')}</label>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        setSelectText("province","${restaurantInfoInstance?.province}");
        //获取市
        ...
        $.get(url,function(data,status){
            ...
            if(data){
                ...
                for(i=0;i<data.length;i++){
                    if(data[i].city=="${restaurantInfoInstance?.city}"){
                ...
                $.get(url,function(data,status){
                    ...
                    if(data){
                        var array=new Array();
                        for(i=0;i<data.length;i++){
                            if(data[i].area=="${restaurantInfoInstance?.area}"){
