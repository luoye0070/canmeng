...
//            boolean has2Code=params.has2Code;//是否扫描了2维码
            ...
            long numInRestaurant=0;//店内编号,暂时不要店内编号
//            def maxNumInRestaurant=OrderInfo.executeQuery("select max(numInRestaurant) from OrderInfo where restaurantId="+restaurantId)[0];
//            if(maxNumInRestaurant)
//                numInRestaurant=maxNumInRestaurant+1;
