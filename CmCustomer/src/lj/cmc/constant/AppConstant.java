...
//		public final static String URL_LOGIN="http://mobile.xjmei.com/user/login";//登录请求地址
		...
		public final static String URL_LOGIN="http://192.168.1.201:8080/canmeng/userAjax/loginAjax";//登录请求地址
		public final static String URL_CREATE_ORDER="http://192.168.1.201:8080/canmeng/customerAjax/createOrder";//创建订单
		public final static String URL_DATA_OF_DISH="http://192.168.1.201:8080/canmeng/customerAjax/dataOfDish";//加载点菜所需数据
		public final static String URL_ADD_DISHS="http://192.168.1.201:8080/canmeng/customerAjax/addDishes";//点菜
		public final static String URL_COMPLETE_DISH="http://192.168.1.201:8080/canmeng/customerAjax/completeDish";//完成点菜
		public final static String URL_ORDER_LIST="http://192.168.1.201:8080/canmeng/customerAjax/orderList";//订单列表
		public final static String URL_ORDER_DETAIL="http://192.168.1.201:8080/canmeng/customerAjax/orderShow";//订单详情
		public final static String URL_CANCEL_DISH="http://192.168.1.201:8080/canmeng/customerAjax/cancelDish";//取消点菜
		public final static String URL_DEL_DISH="http://192.168.1.201:8080/canmeng/customerAjax/delDish";//删除点菜
		
		public final static String URL_CANCEL_ORDER="http://192.168.1.201:8080/canmeng/customerAjax/cancelOrder";//取消订单
		public final static String URL_DEL_ORDER="http://192.168.1.201:8080/canmeng/customerAjax/delOrder";//删除订单
		...
		public final static String URL_TABLE_RESERVE="http://192.168.1.201:8080/canmeng/customerAjax/reserveTable";//桌位预定
