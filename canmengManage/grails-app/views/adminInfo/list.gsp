...
<script type="text/javascript" charset="utf-8">
    ...
    $(function() {
        datagrid = $('#datagrid').datagrid({
            url : "${resource()}/AdminInfo/datagrid",
            pagination : true,
            pagePosition : 'bottom',
            pageSize : 10,
        ...
        var p = parent.sy.dialog({
            ...
            buttons : [ {
                ...
                handler : function() {
                    var f = p.find('form');
                    f.form({
                        url : "${resource()}/AdminInfo/addSaveHandle",
                        success : function(d) {
            ...
            var p = parent.sy.dialog({
                ...
                buttons : [ {
                    ...
                    handler : function() {
                        var f = p.find('form');
                        f.form('submit',{
                            url : "${resource()}/AdminInfo/editUpdHandle",
                            success : function(d) {
                                var json = $.parseJSON(d);
                                if (json.success) {
                                    datagrid.datagrid('reload');
