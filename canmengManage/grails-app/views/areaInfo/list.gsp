        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(function() {
                datagrid = $('#datagrid').datagrid({
                    url : "${resource()}/AreaInfo/datagrid",
                    pagination : true,
                    pagePosition : 'bottom',
                    pageSize : 10,
                ...
                var p = parent.sy.dialog({
                    ...
                    buttons : [ {
                        ...
                        handler : function() {
                            var f = p.find('form');
                            f.form({
                                url : "${resource()}/AreaInfo/addSaveHandle",
                                success : function(d) {
                    ...
                    var p = parent.sy.dialog({
                        ...
                        buttons : [ {
                            ...
                            handler : function() {
                                var f = p.find('form');
                                f.form('submit',{
                                    url : "${resource()}/AreaInfo/editUpdHandle",
                                    success : function(d) {
                                        var json = $.parseJSON(d);
                                        if (json.success) {
                                            datagrid.datagrid('reload');
