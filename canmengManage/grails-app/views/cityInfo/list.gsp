        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(function() {
                datagrid = $('#datagrid').datagrid({
                    url : "${resource()}/CityInfo/datagrid",
                    pagination : true,
                    pagePosition : 'bottom',
                    pageSize : 10,
                ...
                var p = parent.sy.dialog({
                    ...
                    buttons : [ {
                        ...
                        handler : function() {
                            var f = p.find('form');
                            f.form({
                                url : "${resource()}/CityInfo/addSaveHandle",
                                success : function(d) {
                    ...
                    var p = parent.sy.dialog({
                        ...
                        buttons : [ {
                            ...
                            handler : function() {
                                var f = p.find('form');
                                f.form('submit',{
                                    url : "${resource()}/CityInfo/editUpdHandle",
                                    success : function(d) {
                                        var json = $.parseJSON(d);
                                        if (json.success) {
                                            datagrid.datagrid('reload');
